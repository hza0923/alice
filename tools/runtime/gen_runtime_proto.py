#!/usr/bin/env python3
"""Regenerate pp_nextgen/runtime/grpc_gen from pp_nextgen/runtime/proto/pipeline_v2.proto."""
...
def main() -> int:
    ...
    proto = root / "pp_nextgen" / "runtime" / "proto" / "pipeline_v2.proto"
    ...
    cmd = [
        ...
        "grpc_tools.protoc",
        "-I",
        str(root / "pp_nextgen" / "runtime" / "proto"),
        f"--python_out={out}",
