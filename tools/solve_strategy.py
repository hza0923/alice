...
def main() -> int:
    ...
    registry_path = _resolve(str(solve.get("registry_path", "profiling/artifacts/registry/device_registry.v3.json")), [cluster_path.parent, Path.cwd(), root])
    ...
    out_dir = Path(solve.get("out_dir", "scheduler/export"))
