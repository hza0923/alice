...
- `profiling/artifacts/all_results/{model}_{device}.json`
  ...
  "pipeline_stages": [
    {
      ...
      "stage_time_model": {"form": "linear", "c0": 1.1, "c1": 0.0025, "x": "seq_len"},
      "stage_memory_model": {"form": "linear", "c0": 1.6, "c1": 0.0, "x": "seq_len"},
      "comm_bytes_to_next_model": {"form": "linear", "c0": 4096, "c1": 8192, "x": "seq_len"},
...
- `scheduler/export/workers/{worker_name}.strategy.json`
